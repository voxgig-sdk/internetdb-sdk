...
type InfoIpGetEntity struct {
	name    string
	client  *core.InternetdbSDK
...
func NewInfoIpGetEntity(client *core.InternetdbSDK, entopts map[string]any) *InfoIpGetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InfoIpGetEntity) GetName() string { return e.name }
...
func (e *InfoIpGetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InfoIpGetEntity) Deleted() bool {
	return e.deleted
}


func (e *InfoIpGetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInfoIpGetEntity(e.client, opts)
}

func (e *InfoIpGetEntity) Data(args ...any) any {
...
func (e *InfoIpGetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *InfoIpGetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InfoIpGetEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *InfoIpGetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InfoIpGetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InfoIpGetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InfoIpGetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
