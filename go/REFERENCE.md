# Internetdb Golang SDK Reference

Complete API reference for the Internetdb Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *InternetdbSDK`
...
#### `InfoIpGet(data map[string]any) InternetdbEntity`
