...
func (sdk *InternetdbSDK) OptionsMap() map[string]any {
...
func (sdk *InternetdbSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *InternetdbSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *InternetdbSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *InternetdbSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *InternetdbSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *InternetdbSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("InternetdbSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *InternetdbSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *InternetdbSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("InternetdbSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
