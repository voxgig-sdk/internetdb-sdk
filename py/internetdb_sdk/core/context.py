...
from internetdb_sdk.core.helpers import get_ctx_prop, to_map
...
class InternetdbContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, InternetdbSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, InternetdbResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, InternetdbResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return InternetdbError(code, msg, self)
