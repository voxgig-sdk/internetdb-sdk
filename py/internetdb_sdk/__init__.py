...
from internetdb_sdk.utility import register

# Load features
from internetdb_sdk.feature.base_feature import InternetdbBaseFeature
from internetdb_sdk.features import _has_feature, _make_feature
...
class InternetdbSDK:
    ...
    def get_utility(self):
        return InternetdbUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("InternetdbSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def InfoIpGet(self, data=None) -> "InfoIpGetEntity":
        ...
        from internetdb_sdk.entity.info_ip_get_entity import InfoIpGetEntity
