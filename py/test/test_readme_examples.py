# Internetdb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions InternetdbSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both InternetdbSDK(...) and InternetdbSDK.test(...) become
#      InternetdbSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "internetdb_sdk"
_SDK_CLASS = "InternetdbSDK"
