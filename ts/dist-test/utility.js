...
function envOverride(m) {
    if ('TRUE' === process.env.INTERNETDB_TEST_LIVE ||
        'TRUE' === process.env.INTERNETDB_TEST_OVERRIDE) {
    ...
    m.INTERNETDB_TEST_EXPLAIN = process.env.INTERNETDB_TEST_EXPLAIN || m.INTERNETDB_TEST_EXPLAIN;
    return m;
}
