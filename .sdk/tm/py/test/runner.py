...
class InternetdbTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InternetdbTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = InternetdbTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = InternetdbTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
