...
class InternetdbTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InternetdbTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = InternetdbTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = InternetdbTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
