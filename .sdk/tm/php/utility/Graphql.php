...
// Internetdb SDK utility: graphql
//
...
class InternetdbGraphql
{
    ...
    // equivalent.
    public static function body(InternetdbContext $ctx): mixed
    {
    ...
    public static function errors(InternetdbContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
