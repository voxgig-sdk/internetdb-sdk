...
// Internetdb SDK ratelimit feature
...
class InternetdbRatelimitFeature extends InternetdbBaseFeature
{
    ...
    private function _acquire(InternetdbContext $ctx): void
    {
    ...
    private function _track(InternetdbContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
