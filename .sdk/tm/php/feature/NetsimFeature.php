...
class InternetdbNetsimFeature extends InternetdbBaseFeature
{
    ...
    private function _simulate(InternetdbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(InternetdbContext $ctx, array $applied): void
    {
        $client = $this->client;
