...
// Internetdb SDK streaming feature
...
class InternetdbStreamingFeature extends InternetdbBaseFeature
{
    ...
    private function _iterate(InternetdbResult $result): \Generator
    {
    ...
    private function _streamable(InternetdbContext $ctx): bool
    {
