...
// Internetdb SDK clienttrack feature
...
class InternetdbClienttrackFeature extends InternetdbBaseFeature
{
    ...
    public function PostConstruct(InternetdbContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Internetdb-SDK';
