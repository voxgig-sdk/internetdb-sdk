...
class InternetdbProxyFeature extends InternetdbBaseFeature
{
    ...
    public function init(InternetdbContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (InternetdbContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
