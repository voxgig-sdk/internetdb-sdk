...
|---|---|---|
| `ts/` | @voxgig-sdk/internetdb-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/internetdb-sdk \
      --repository voxgig-sdk/internetdb-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/internetdb-sdk` shows it, and
`npm trust revoke @voxgig-sdk/internetdb-sdk --id=<id>` removes it.
