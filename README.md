...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/internetdb` | `npm install @voxgig-sdk/internetdb` |
| Python | `voxgig-sdk-internetdb` | `pip install voxgig-sdk-internetdb` |
| PHP | `voxgig-sdk/internetdb` | `composer require voxgig-sdk/internetdb` |
| Golang | `github.com/voxgig-sdk/internetdb-sdk/go` | `go get github.com/voxgig-sdk/internetdb-sdk/go` |
| Ruby | `voxgig-sdk-internetdb` | `gem install voxgig-sdk-internetdb` |
| Lua | `voxgig-sdk-internetdb` | `luarocks install voxgig-sdk-internetdb` |
