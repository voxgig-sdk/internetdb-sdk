...
func registerSDKWords(r *eng.Registry, client *sdk.InternetdbSDK) {
...
func runOp(client *sdk.InternetdbSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
