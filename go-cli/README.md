...
AQL-driven CLI and REPL for the Internetdb SDK. Positional arguments are
...
./internetdb-cli load 1 info_ip_get
./internetdb-cli load '{id:1}' info_ip_get
