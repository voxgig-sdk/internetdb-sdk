...
local InternetdbSDK = {}
InternetdbSDK.__index = InternetdbSDK
...
InternetdbSDK._make_feature = _make_feature


function InternetdbSDK.new(options)
  local self = setmetatable({}, InternetdbSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function InternetdbSDK:options_map()
...
function InternetdbSDK:get_utility()
  return Utility.copy(self._utility)
end


function InternetdbSDK:get_root_ctx()
  return self._rootctx
end


function InternetdbSDK:prepare(fetchargs)
...
function InternetdbSDK:direct(fetchargs)
...
-- by passing it.
function InternetdbSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function InternetdbSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "InternetdbSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function InternetdbSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = InternetdbSDK.new(sdkopts)
  sdk.mode = "test"
