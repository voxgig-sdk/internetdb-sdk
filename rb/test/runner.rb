...
module InternetdbTestRunner
  ...
  def self.env_override(m)
    live = getenv("INTERNETDB_TEST_LIVE")
    override = getenv("INTERNETDB_TEST_OVERRIDE")
    ...
    explain = getenv("INTERNETDB_TEST_EXPLAIN")
    m["INTERNETDB_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = InternetdbTestRunner
Helpers = InternetdbHelpers
Vs = VoxgigStruct
