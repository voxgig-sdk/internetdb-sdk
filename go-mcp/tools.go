...
type Args struct {
	Entity string         `json:"entity" jsonschema:"info_ip_get"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.InternetdbSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "internetdb_list",
		Description: "List records from Internetdb. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "internetdb_load",
		Description: "Load a single record from Internetdb. " +
...
func runOp(client *sdk.InternetdbSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.InternetdbSDK, name string) (sdk.InternetdbEntity, error) {
	switch strings.ToLower(name) {
	case "info_ip_get":
		return client.InfoIpGet(nil), nil
