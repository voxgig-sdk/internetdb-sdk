// Command Internetdb-mcp is an MCP server exposing the Internetdb
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Internetdb_list  — list records of an entity
//	Internetdb_load  — load a single record of an entity
//
