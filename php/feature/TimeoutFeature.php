...
// Internetdb SDK timeout feature
...
class InternetdbTimeoutFeature extends InternetdbBaseFeature
{
    ...
    private function _with_timeout(InternetdbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(InternetdbContext $_ctx, float $ms): void
    {
        $client = $this->client;
