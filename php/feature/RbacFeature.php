...
class InternetdbRbacFeature extends InternetdbBaseFeature
{
    ...
    private function _required(InternetdbContext $ctx): ?string
    {
    ...
    private function _reject(InternetdbContext $ctx, string $required): void
    {
    ...
    private function _track(InternetdbContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
