...
// Internetdb SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class InternetdbTestFeature extends InternetdbBaseFeature
{
    ...
    public function init(InternetdbContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (InternetdbContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = InternetdbParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (InternetdbContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(InternetdbContext $ctx, $op, $args): array
    {
