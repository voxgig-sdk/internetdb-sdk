...
// Internetdb SDK idempotency feature
...
class InternetdbIdempotencyFeature extends InternetdbBaseFeature
{
    ...
    private function _mutating(InternetdbContext $ctx): bool
    {
