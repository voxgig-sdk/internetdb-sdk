...
class InternetdbCacheFeature extends InternetdbBaseFeature
{
    ...
    private function _through(InternetdbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
