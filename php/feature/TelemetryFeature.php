...
// Internetdb SDK telemetry feature
...
class InternetdbTelemetryFeature extends InternetdbBaseFeature
{
    ...
    private function _close(InternetdbContext $ctx, bool $ok): void
    {
