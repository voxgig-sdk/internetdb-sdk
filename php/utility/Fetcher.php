...
// Internetdb SDK utility: fetcher

class InternetdbFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; InternetdbSDK/1.0)';
    ...
    public static function call(InternetdbContext $ctx, string $fullurl, array $fetchdef): array
    {
