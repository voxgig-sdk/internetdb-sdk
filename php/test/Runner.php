...
class InternetdbTestRunner
{
    ...
    {
        $live = self::getenv('INTERNETDB_TEST_LIVE');
        $override = self::getenv('INTERNETDB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('INTERNETDB_TEST_EXPLAIN');
...
class_alias('InternetdbTestRunner', 'Runner');
class_alias('InternetdbHelpers', 'Helpers');
