...
// Internetdb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (InternetdbSDK::test)
...
{
    private const SDK_CLASS = 'InternetdbSDK';
    ...
    private const SDK_BASE = 'internetdb_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../internetdb_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
