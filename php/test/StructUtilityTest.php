...
// Internetdb SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = InternetdbOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(InternetdbOmni::structfix($now, Struct::undef()))
                        !== json_encode(InternetdbOmni::structfix($val, Struct::undef()))) {
